 ...
 *
 * - summarizeNotes - A function that summarizes notes for accessibility.
...
const summarizeNotesPrompt = ai.definePrompt({
  ...
  prompt: `Summarize the following notes for a student to quickly review the key concepts:\n\n{{{notes}}}`,
});
