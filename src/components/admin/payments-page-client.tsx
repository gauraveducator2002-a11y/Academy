...
import { ContentContext, DiscountCode, Transaction } from '@/context/content-context';
...
export default function PaymentsPageClient() {
    ...
    async function onDiscountSubmit(values: z.infer<typeof discountFormSchema>) {
        ...
        await addDiscountCode({ code: values.code.toUpperCase(), discount: values.discount });
        toast({
            title: 'Success!',
